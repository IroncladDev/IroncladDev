export const tokens = {
  ...
  subgroundRoot: "var(--subground-root)",
  subgroundDefault: "var(--subground-default)",
  subgroundHigher: "var(--subground-higher)",
  subgroundHighest: "var(--subground-highest)",

  linearRoot: "var(--linear-root)",
  linearDefault: "var(--linear-default)",
  linearHigher: "var(--linear-higher)",
  linearHighest: "var(--linear-highest)",
