...
const Content: AboutContent = {
  ...
  journey: {
    ...
    paragraphs: [
      ...
      "Discord completely changed the way I saw programming, and how communities were structured.  I was able to communicate in realtime with many other programmers and learn how to code so much faster.  On the other side of discord, however, I did some really stupid stuff, got my account nuked, and hung around people I really shouldn't have.",
  ...
  faq: {
    ...
    paragraphs: [
      ...
      "**Q: What do you have against python?**\n\n**A**: The fact that python uses indentation instead of curly braces for indentation is **disgusting**.  Object indexing is also annoying that you can't use dot notation.  Performance is slow, etc.",
